...
/*!***************************!*\
  !*** ./common/actions.js ***!
  \***************************/
/*! exports provided: composeRemoteAction, runRequest, fetchUserPreferences, fetchUserPreferencesSuccess, fetchUserPreferencesFailed, storeUserPreferencesSuccess, storeUserPreferencesFailed, cacheTokenRequest, cacheTokenFailed, cacheTokenSuccess, fetchCacheToken, fetchCacheTokenFailed, fetchCacheTokenSuccess, validateCanRunRequest, loginSuccess */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "cacheTokenRequest", function() { return cacheTokenRequest; });
...
const cacheTokenRequest = token => ({
  type: _keys__WEBPACK_IMPORTED_MODULE_0__["ACTIONS"].CACHE_TOKEN.REQUEST,
  payload: {
    token
  }
});
...
const loginSuccess = token => ({
  type: _keys__WEBPACK_IMPORTED_MODULE_0__["ACTIONS"].LOGIN.SUCCESS,
  payload: {
    token
  }
});
...
portMessages$
  .pipe(
    Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(evt => {
      if (evt && evt.dest === _diff_common_keys__WEBPACK_IMPORTED_MODULE_0__["MESSAGES_FRONTEND_SOURCE"]) {
...
/*!*****************************!*\
  !*** ./content/frontend.js ***!
  \*****************************/
/*! exports provided: addScriptToPage, runFrontend */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addScriptToPage", function() { return addScriptToPage; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "runFrontend", function() { return runFrontend; });
/**
 * @param {*} scriptName
 * @param {*} scriptId
 */
...
const messages$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["fromEvent"])(window, "message").pipe(
  Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["filter"])(evt => {
    if (!evt.data) {
      return false;
    }
    if (evt.dest === _diff_common_keys__WEBPACK_IMPORTED_MODULE_2__["MESSAGES_FRONTEND_SOURCE"]) {
      return false;
    }
    if (evt.data && evt.data.dest === _diff_common_keys__WEBPACK_IMPORTED_MODULE_2__["MESSAGES_FRONTEND_SOURCE"]) {
      return false;
    }
...
const frontend$ = messages$.pipe(
  ...
  Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(evt =>
    console.log(
...
const FORWARD_MESSAGE_TYPES = [
  _diff_common_keys__WEBPACK_IMPORTED_MODULE_2__["ACTIONS"].CACHE_TOKEN.REQUEST,
  _diff_common_keys__WEBPACK_IMPORTED_MODULE_2__["ACTIONS"].FETCH_CACHE_TOKEN.REQUEST
];

const cacheRequest$ = frontend$.pipe(
  Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(evt => evt.data),
  Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["filter"])(data => FORWARD_MESSAGE_TYPES.includes(data.type))
);
